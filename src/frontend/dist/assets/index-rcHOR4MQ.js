...
const SESSION_MAX_TTL = BigInt(7 * 24 * 60 * 60) * BigInt(1e9);
const SS_PENDING_KEY = "ts_pending_wallet_type";
const win = () => window;
function isPlugInstalled() {
  var _a2;
  return !!((_a2 = win().ic) == null ? void 0 : _a2.plug);
}
async function getPlugPrincipal() {
  var _a2, _b2, _c2, _d2;
  try {
    const agent = (_b2 = (_a2 = win().ic) == null ? void 0 : _a2.plug) == null ? void 0 : _b2.agent;
    if (agent) {
      const p = await agent.getPrincipal();
      return (p == null ? void 0 : p.toString()) ?? null;
    }
    return ((_d2 = (_c2 = win().ic) == null ? void 0 : _c2.plug) == null ? void 0 : _d2.principalId) ?? null;
  } catch {
    return null;
  }
}
...
function useICPWallet() {
  const [walletState, setWalletState] = reactExports.useState(INITIAL_STATE);
  reactExports.useEffect(() => {
    var _a2;
    let cancelled = false;
    ...
    if (pendingWalletType === "nns" || pendingWalletType === "nfid") {
      __vitePreload(async () => {
        const { AuthClient: AuthClient2 } = await Promise.resolve().then(() => index);
        return { AuthClient: AuthClient2 };
      }, true ? void 0 : void 0).then(
        ({ AuthClient: AuthClient2 }) => AuthClient2.create({
          idleOptions: {
            disableIdle: true,
        ...
        sessionStorage.removeItem(SS_PENDING_KEY);
        if (isAuth) {
          const identity = client2.getIdentity();
    ...
    if (session.walletType === "nns" || session.walletType === "nfid") {
      ...
      const plug = (_a2 = win().ic) == null ? void 0 : _a2.plug;
      if (plug) {
        Promise.resolve(
    ...
    } else if (session.walletType === "bitfinity" || session.walletType === "stoic") {
      setWalletState((p) => ({
        ...p,
        connected: true,
        walletType: session.walletType,
  ...
  const forceLoginCheck = reactExports.useCallback(async () => {
    var _a2;
    try {
      const { AuthClient: AuthClient2 } = await __vitePreload(async () => {
        const { AuthClient: AuthClient3 } = await Promise.resolve().then(() => index);
      ...
      if (isAuth) {
        const identity = client2.getIdentity();
        const principal = identity.getPrincipal().toString();
        const walletType = sessionStorage.getItem(SS_PENDING_KEY) ?? ((_a2 = getStoredSession()) == null ? void 0 : _a2.walletType) ?? "nns";
        sessionStorage.removeItem(SS_PENDING_KEY);
  ...
  const connectWallet = reactExports.useCallback(async (type) => {
    var _a2, _b2;
    if (type === "nns" || type === "nfid") {
      const providerUrl = type === "nns" ? "https://identity.ic0.app" : "https://nfid.one/authenticate";
      setWalletState((p) => ({
        ...p,
        connecting: true,
        error: null,
      ...
      try {
        ...
        const authClient = await AuthClient2.create({
          idleOptions: { disableIdle: true, disableDefaultIdleCallback: true }
        });
        ...
        sessionStorage.removeItem(SS_PENDING_KEY);
        const msg = e instanceof Error ? e.message : `${type === "nns" ? "NNS" : "NFID"} login failed`;
        setWalletState((p) => ({
          ...p,
          connecting: false,
          error: msg,
    ...
    try {
      if (type === "plug") {
        ...
        const ic = ((_a2 = win().ic) == null ? void 0 : _a2.bitfinityWallet) ?? win().bitfinityWallet;
        if (!ic) {
          window.open(
        ...
        let principal = null;
        try {
          const rawPrincipal = await ((_b2 = ic.getPrincipal) == null ? void 0 : _b2.call(ic));
        ...
        setWalletState((p) => ({
          ...p,
          connecting: false,
          error: "Stoic Web App opened. Approve the connection, then return here."
        }));
      }
    } catch (e) {
  ...
  const connectManualPrincipal = reactExports.useCallback((principal) => {
  ...
  const payWithWallet = reactExports.useCallback(
    async (recipientAccountId, amountE8s) => {
      var _a2;
  ...
  const disconnect = reactExports.useCallback(async () => {
    clearSession();
    const wt2 = walletState.walletType;
    if (wt2 === "nns" || wt2 === "nfid") {
      try {
        const { AuthClient: AuthClient2 } = await __vitePreload(async () => {
          const { AuthClient: AuthClient3 } = await Promise.resolve().then(() => index);
...
function fmt$1(n) {
  if (n < 1e-5) return n.toFixed(8);
  if (n < 1e-3) return n.toFixed(6);
...
function AdminPanel({
  ...
  const [stats] = reactExports.useState(getStats);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "min-h-screen bg-[#080B14] flex items-center justify-center p-4", children: !isAuthenticated ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-[#0D1117] rounded-xl border border-[#1C2333] p-8 w-full max-w-sm", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mb-2", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Shield, { size: 20, className: "text-[#D4AF37]" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-white font-mono font-bold", children: "Admin Access Required" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-500 text-xs font-mono mb-6", children: "Connect the Admin Principal ID wallet to access analytics." }),
    walletState.error && /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
        "data-ocid": "admin.error_state",
        className: "bg-[#FF3B5C]/10 border border-[#FF3B5C]/40 rounded-lg p-3 mb-4 text-[#FF3B5C] text-xs font-mono",
        children: walletState.error
      }
    ),
    effectivePrincipal && effectivePrincipal !== ADMIN_PRINCIPAL && /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        "data-ocid": "admin.error_state",
        className: "bg-[#FF3B5C]/10 border border-[#FF3B5C]/40 rounded-lg p-3 mb-4",
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[#FF3B5C] font-mono text-xs font-bold", children: "⛔ Access Denied" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-[#FF3B5C]/70 font-mono text-[10px] mt-1", children: [
            "Connected: ",
            effectivePrincipal.slice(0, 20),
            "…"
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[#FF3B5C]/70 font-mono text-[10px]", children: "This is not the admin principal." })
        ]
      }
    ),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-2", children: walletButtons.map(({ type, label, icon }) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "button",
      {
        type: "button",
        ...
        children: [
          walletState.connecting && walletState.walletType === type ? /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "inline-block w-3 h-3 border-2 border-[#D4AF37] border-t-transparent rounded-full animate-spin" }) : icon,
          " ",
          label
        ]
      },
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-700 text-[10px] font-mono mt-4 text-center", children: "Access requires Admin Principal ID" })
  ] }) : /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-[#0D1117] rounded-xl border border-[#1C2333] p-8 w-full max-w-lg", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mb-1", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Shield, { size: 20, className: "text-[#00FF88]" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-white font-mono font-bold", children: "Admin Analytics" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[#00FF88] text-[10px] font-mono ml-auto bg-[#00FF88]/10 px-2 py-0.5 rounded border border-[#00FF88]/30", children: "✓ ADMIN" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-gray-600 text-[10px] font-mono mb-6", children: [
      "Principal: ",
      effectivePrincipal == null ? void 0 : effectivePrincipal.slice(0, 30),
      "…"
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 gap-3 mb-6", children: [
      ...
      {
        label: "Last Visit",
        value: stats.lastVisit ? new Date(stats.lastVisit).toLocaleDateString("en-US", {
          month: "short",
          day: "numeric"
        }) : "—",
        color: "#9945FF",
      ...
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1.5 mb-1", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-500 text-[10px] font-mono", children: label })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-mono font-bold text-2xl", style: { color }, children: value })
        ]
      },
      label
    )) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-[#080B14] rounded-lg border border-[#1C2333] p-3 mb-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mb-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm", children: "⚡" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-400 text-xs font-mono uppercase tracking-wider", children: "Active Signals" }),
      ...
      activeSignals.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-600 font-mono text-xs text-center py-3", children: "No active signals" }) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-2", children: activeSignals.map((signal, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1.5 mb-0.5", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-white font-mono font-bold text-xs", children: signal.coin }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-gray-500 font-mono text-[10px]", children: signal.symbol }),
                signal.isGoldenSniper && /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "span",
                  {
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap gap-x-3 gap-y-0.5", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-gray-400 font-mono text-[10px]", children: [
                  "E: $",
                  fmt$1(signal.entry)
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-[#00FF88] font-mono text-[10px]", children: [
                  "TP1: $",
                  fmt$1(signal.tp1)
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-[#00D4FF] font-mono text-[10px]", children: [
                  "TP2: $",
                  fmt$1(signal.tp2)
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-[#9945FF] font-mono text-[10px]", children: [
                  "TP3: $",
                  fmt$1(signal.tp3)
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-[#FF3B5C] font-mono text-[10px]", children: [
                  "SL: $",
                  fmt$1(signal.sl)
                ] })
              ] })
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "button",
              {
                ...
                onClick: () => onManualClose == null ? void 0 : onManualClose(signal.id),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-[#080B14] rounded-lg border border-[#1C2333] p-3 mb-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mb-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Users, { size: 13, className: "text-gray-500" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-500 text-[10px] font-mono uppercase tracking-wider", children: "Session Details" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-400 text-xs font-mono", children: "Stats are session-local (localStorage). For full server-side analytics, backend integration is required." })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "button",
      {
...
function relativeTime$1(ts) {
  const totalMins = Math.floor((Date.now() - ts) / 6e4);
...
function ScanningState() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center py-6", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "relative inline-flex items-center justify-center mb-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "div",
              {
                ...
                style: {
                  background: "conic-gradient(from 0deg, transparent 270deg, rgba(212,175,55,0.6) 360deg)",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "p",
        {
          ...
          children: "AI SCANNING MARKET..."
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-500 text-xs font-mono mb-4", children: "Waiting for 99%+ confidence Golden Sniper setup" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center justify-center gap-3", children: SCAN_CHECKS.map((check, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1.5", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-gray-600 text-[9px] font-mono hidden sm:block", children: check.label })
      ] }, check.label)) })
    ] })
  ] });
}
function GoldenSniper({ signal, scanningForGoldenSniper }) {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Crown, { className: "text-[#D4AF37]", size: 16 }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[#D4AF37] font-mono font-bold text-sm tracking-wider", children: "GOLDEN SNIPER" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "span",
                {
        ...
        scanningForGoldenSniper || !signal ? /* @__PURE__ */ jsxRuntimeExports.jsx(ScanningState, {}) : /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mb-4", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "div",
              {
                ...
                style: {
                  background: `${COIN_COLORS$2[signal.symbol] ?? "#D4AF37"}20`,
                  border: `2px solid ${COIN_COLORS$2[signal.symbol] ?? "#D4AF37"}80`,
                  color: COIN_COLORS$2[signal.symbol] ?? "#D4AF37"
                },
                children: signal.symbol.replace("USDT", "").slice(0, 3)
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-white font-bold", children: signal.coin }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "span",
                  {
                    ...
                    style: {
                      ...
                      borderColor: signal.direction === "BUY" ? "#00FF88" : "#FF3B5C",
                      background: signal.direction === "BUY" ? "rgba(0,255,136,0.12)" : "rgba(255,59,92,0.12)"
                    },
                    children: signal.direction === "BUY" ? "▲ BUY" : "▼ SELL"
                  }
                ),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "span",
                  {
                    ...
                    children: "\\u2726 ACTIVE SWING"
                  }
                )
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1 mt-1", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-gray-500 text-[10px] font-mono", children: [
                  "\\uD83D\\uDD50 ",
                  signal.displayTime
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-gray-600 text-[10px]", children: "\\u00b7" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-gray-500 text-[10px] font-mono", children: relativeTime$1(signal.createdAt) })
              ] })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "ml-auto text-right", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-[#D4AF37] font-mono font-bold text-lg", children: [
                signal.confidence,
                "%"
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-gray-500 text-[9px] font-mono", children: "confidence" })
            ] })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1 mb-3 flex-wrap", children: [
            signal.smcTags.map((tag) => /* @__PURE__ */ jsxRuntimeExports.jsx(
              "span",
              {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-5 gap-2 mb-3", children: [
            ...
            "div",
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[9px] font-mono text-gray-500 mb-0.5", children: label }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "div",
                  {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-400 text-[10px] font-mono leading-relaxed", children: signal.rationale }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-2 text-[9px] font-mono text-gray-600", children: [
            "R/R Ratio: ",
            signal.rrRatio,
            " \\u00b7 Signal active until TP3 or SL hit"
          ] })
        ] })
      ]
    }
...
function getLivePrice(symbol) {
  var _a2, _b2;
  const p = (_b2 = (_a2 = window.TS_ULTRA_STATE) == null ? void 0 : _a2.livePrices) == null ? void 0 : _b2[symbol.toUpperCase()];
  return p && p > 0 ? p : null;
}
function SignalCard({ signal, index: index2 }) {
  const color = COIN_COLORS$1[signal.symbol] ?? "#D4AF37";
  const directionColor = signal.direction === "BUY" ? "#00FF88" : "#FF3B5C";
  const [livePrice, setLivePrice] = reactExports.useState(null);
  reactExports.useEffect(() => {
  ...
  const priceDeviation = livePrice ? (livePrice - signal.entry) / signal.entry * 100 : null;
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "div",
    {
      "data-ocid": `signal.item.${index2 + 1}`,
      className: "relative bg-[#0D1117] rounded-xl border border-[#1C2333] overflow-hidden",
      style: { borderLeft: `3px solid ${directionColor}` },
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-3 md:p-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mb-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1.5 flex-wrap", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-white font-bold text-sm", children: signal.coin }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "span",
                {
                  className: "text-[10px] font-mono px-2 py-0.5 rounded-full font-bold border",
              ...
              signal.isGolden ? /* @__PURE__ */ jsxRuntimeExports.jsx(
                "span",
                {
                  className: "text-[10px] font-mono px-2 py-0.5 rounded-full font-bold border",
                  style: {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            ...
            children: [
              ...
              { label: "TP3", value: signal.tp3, color: "#FFD700" },
              { label: "SL", value: signal.sl, color: "#FF3B5C" }
            ].map(({ label, value, color: c }) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "div",
              {
        ...
        livePrice && /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-[10px] font-mono text-gray-400", children: [
                "Now:",
                " ",
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[#00D4FF] font-bold", children: fmtPrice(livePrice) })
              ] }),
              priceDeviation !== null && /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "span",
                {
                  className: "text-[10px] font-mono font-bold ml-1",
                  style: {
                    color: priceDeviation > 0 ? "#00FF88" : priceDeviation < 0 ? "#FF3B5C" : "#6B7280"
                  },
                  children: [
                    "(",
                    priceDeviation > 0 ? "+" : "",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-400 text-[10px] font-mono leading-relaxed mb-2 line-clamp-2", children: signal.rationale }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between flex-wrap gap-1", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 text-[10px] font-mono text-gray-500", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { children: [
              "\\uD83D\\uDD50 Detected: ",
              signal.displayTime
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-gray-600", children: "\\u00b7" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: relativeTime(signal.createdAt) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-gray-600", children: "\\u00b7" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "span",
              {
                style: {
                  color: signal.expiryTime - Date.now() < 36e5 ? "#FF3B5C" : "#6B7280"
                },
                children: expiresIn(signal.expiryTime)
              }
            )
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 text-[10px] font-mono text-gray-500", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
                ...
                title: "Share",
                children: /* @__PURE__ */ jsxRuntimeExports.jsx(Share2, { size: 11 })
              }
            )
          ] })
        ] })
...
function AlphaSection({ signals }) {
  const goldenSignal = signals.find((s) => s.isGolden) ?? null;
  const regularSignals = signals.filter((s) => !s.isGolden);
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { "data-ocid": "signals.section", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mb-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-white font-mono font-bold text-base", children: "Active Swing Signals" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-500 text-xs font-mono mt-0.5", children: "4H + 1D SMC Analysis \\u00b7 24-Hour Signal Lifecycle" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "span",
        {
    ...
    regularSignals.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              ...
              children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[#D4AF37]/50 text-lg", children: "\\u25c9" })
            }
          ),
          "AI Scanner active \\u2014 awaiting high-confidence setups (>95%)"
        ]
      }
    ) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid gap-3 md:grid-cols-2", children: regularSignals.map((signal, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(SignalCard, { signal, index: i }, signal.id)) })
  ] });
}
...
const GEM_SYMBOLS = /* @__PURE__ */ new Set(["PEPEUSDT", "SHIBUSDT"]);
const MID_CAP_SYMBOLS = /* @__PURE__ */ new Set([
  "LINKUSDT",
  "MATICUSDT",
  "ICPUSDT",
  "UNIUSDT",
...
function getDirectionBias(dir) {
  try {
    const aiRaw = localStorage.getItem(AI_MODEL_KEY);
    if (aiRaw) {
      const ai = JSON.parse(aiRaw);
      const data2 = ai[dir];
      if (data2 && data2.total >= 3) {
        const rate2 = data2.wins / data2.total;
        return rate2 > 0.75 ? 3 : rate2 > 0.6 ? 1 : rate2 < 0.25 ? -3 : rate2 < 0.4 ? -1 : 0;
      }
    }
...
function buildSignal(symbol, priceData, idx, preservedCreatedAt) {
  ...
  const priceInRange = priceRange > 0 ? (price - priceData.low24h) / priceRange : 0.5;
  const volumeRatio = priceData.marketCap > 0 ? priceData.volume24h / priceData.marketCap : 0;
  const direction = change24h > 0.5 || priceInRange > 0.5 && change24h > -1 ? "BUY" : "SELL";
  const entry = price;
  let tp1;
  let tp2;
  let tp3;
  ...
  const isGoldenSniperEligible = confidence > 95 && winRate > 90 && bullishMomentum && tags.includes("Liquidity Sweep") && tags.includes("FVG");
...
function makeFallbackPriceData(symbol) {
...
function useTokenData() {
  ...
  const [signals, setSignals] = reactExports.useState(() => {
    ...
    return TRACKED_SYMBOLS.map((symbol, idx) => {
      ...
      return buildSignal(symbol, fb, idx);
    });
  });
  const [connected, setConnected] = reactExports.useState(false);
  const prevPrices = reactExports.useRef({});
  const flashTimers = reactExports.useRef({});
  const wsRef = reactExports.useRef(null);
  const signalCache = reactExports.useRef(loadSignalCache());
  const marketCaps = reactExports.useRef({});
  reactExports.useEffect(() => {
    ...
    const fetchMC = () => {
      fetch(
        ...
        for (const item of data) {
          const symbol = (_a2 = Object.entries(COINGECKO_IDS).find(
            ([, gid]) => gid === item.id
          )) == null ? void 0 : _a2[0];
    ...
    fetchMC();
    const interval = setInterval(fetchMC, 6e4);
    return () => clearInterval(interval);
  }, []);
  const refreshSignals = reactExports.useCallback((priceMap) => {
    ...
    const updated = TRACKED_SYMBOLS.map((s, i) => {
      ...
      const fresh = buildSignal(s, priceData, i);
  ...
  reactExports.useEffect(() => {
    ...
    const check = () => {
      ...
      for (const s of TRACKED_SYMBOLS) {
        ...
        const entryZoneHit = Math.abs(currentPrice - sig.entry) / sig.entry <= ZONE_TOL;
      ...
      if (changed) {
        ...
        setSignals(
          TRACKED_SYMBOLS.map((s, i) => {
            ...
            const fresh = buildSignal(s, fb, i);
            signalCache.current[s] = fresh;
            return fresh;
          })
        );
    ...
    const iv = setInterval(check, 6e4);
    return () => clearInterval(iv);
  }, []);
  reactExports.useEffect(() => {
    let reconnectTimer;
    function connect2() {
      ...
      ws.onclose = () => {
        setConnected(false);
        reconnectTimer = setTimeout(connect2, 3e3);
      };
      ws.onerror = () => ws.close();
      ws.onmessage = (event) => {
  ...
  const scanningForGoldenSniper = connected && !signals.some((s) => s.isGoldenSniperEligible);
  return { prices, signals, connected, scanningForGoldenSniper };
}
function getLabel(v2) {
  if (v2 < 20) return { label: "Extreme Fear", color: "#FF3B5C" };
  if (v2 < 40) return { label: "Fear", color: "#FF8C42" };
  if (v2 < 60) return { label: "Neutral", color: "#FFD700" };
  if (v2 < 80) return { label: "Greed", color: "#7FFF00" };
  return { label: "Extreme Greed", color: "#00FF88" };
}
function computeMarketMomentum(prices) {
  const values = Object.values(prices);
  if (values.length === 0) return 50;
  const gainers = values.filter((p) => p.change24h > 0).length;
  const gainerRatio = gainers / values.length;
  const avgChange = values.reduce((sum, p) => sum + p.change24h, 0) / values.length;
  const changeSentiment = Math.max(0, Math.min(100, (avgChange + 10) * 5));
  const avgVolRatio = values.filter((p) => p.marketCap > 0).reduce((s, p) => s + p.volume24h / p.marketCap, 0) / Math.max(1, values.filter((p) => p.marketCap > 0).length);
...
function SentimentGauge({
  ...
  const [momentum, setMomentum] = reactExports.useState(55);
  reactExports.useEffect(() => {
  ...
  const combined = value !== void 0 ? value : Math.round(fgScore * 0.6 + momentum * 0.4);
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "svg",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("title", { children: "Market Sentiment Gauge" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "path",
                {
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("circle", { cx: "100", cy: "100", r: "6", fill: color }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("circle", { cx: "100", cy: "100", r: "3", fill: "#080B14" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "text",
                {
                  x: "100",
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("text", { x: "12", y: "114", fill: "#FF3B5C", fontSize: "7", fontFamily: "monospace", children: "FEAR" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "text",
                {
                  x: "158",
        ...
        showSubScores && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 gap-3 w-full max-w-xs mt-1", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-[#0D1117] rounded-lg p-2 text-center border border-[#1C2333]", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[10px] text-gray-500 mb-0.5", children: "Market Momentum" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "p",
              {
                className: "text-sm font-mono font-bold",
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[9px] text-gray-600 font-mono", children: "Live price action" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-[#0D1117] rounded-lg p-2 text-center border border-[#1C2333]", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[10px] text-gray-500 mb-0.5", children: "Social Sentiment" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "p",
              {
                className: "text-sm font-mono font-bold",
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[9px] text-gray-600 font-mono", children: "Fear & Greed Index" })
          ] })
        ] })
      ]
    }
...
function fmt(n, lastKnown) {
  const v2 = !n || Number.isNaN(n) || n <= 0 ? 0 : n;
  if (v2 <= 0) return "—";
  if (v2 >= 1) {
    return v2.toLocaleString("en-US", {
      minimumFractionDigits: 2,
      maximumFractionDigits: 2
    });
  }
  if (v2 < 1e-3) return v2.toFixed(8);
  return v2.toFixed(6);
}
function fmtMC(n) {
  if (!n) return "—";
...
function getWsPrice(symbol) {
  var _a2, _b2;
  const p = (_b2 = (_a2 = window.TS_ULTRA_STATE) == null ? void 0 : _a2.livePrices) == null ? void 0 : _b2[symbol];
  return p && p > 0 ? p : null;
}
function DashboardTab({
  ...
  const [fearGreed, setFearGreed] = reactExports.useState(null);
  const [fgLoading, setFgLoading] = reactExports.useState(true);
  const [flashMap, setFlashMap] = reactExports.useState({});
  const prevPricesRef = reactExports.useRef({});
  const flashTimersRef = reactExports.useRef(
    {}
  );
  const loadedCount = TRACKED_SYMBOLS.filter((s) => prices[s]).length;
  const lastKnownPricesRef = reactExports.useRef({});
  reactExports.useEffect(() => {
  ...
  reactExports.useEffect(() => {
    const iv = setInterval(() => {
      var _a2;
      const wsState = ((_a2 = window.TS_ULTRA_STATE) == null ? void 0 : _a2.livePrices) ?? {};
      const updates = {};
      for (const [sym, price] of Object.entries(wsState)) {
        const prev = prevPricesRef.current[sym];
        if (prev !== void 0 && price !== prev) {
  ...
  reactExports.useEffect(() => {
    const fetchFG = () => {
      setFgLoading(true);
      fetch("https://api.alternative.me/fng/?limit=1").then((r2) => r2.json()).then((d) => {
        var _a2;
        const item = (_a2 = d == null ? void 0 : d.data) == null ? void 0 : _a2[0];
        if (item)
          setFearGreed({
    ...
    fetchFG();
    const iv = setInterval(fetchFG, 3e5);
    return () => clearInterval(iv);
  }, []);
  ...
  const winRate = completedHistory.length > 0 ? (winCount / completedHistory.length * 100).toFixed(1) : null;
  const avgRR = completedHistory.length > 0 ? (() => {
    const nums = completedHistory.map((e) => {
      const parts = e.rrRatio.split(":");
      return parts[1] ? Number.parseFloat(parts[1]) : 3;
    });
    const avg = nums.reduce((a, b) => a + b, 0) / nums.length;
    return `1:${avg.toFixed(1)}`;
  })() : null;
  const fearGreedColor = fearGreed ? fearGreed.value < 25 ? "#FF3B5C" : fearGreed.value < 45 ? "#FF9500" : fearGreed.value < 55 ? "#D4AF37" : fearGreed.value < 75 ? "#00D4FF" : "#00FF88" : "#D4AF37";
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "span",
          {
            className: `w-2 h-2 rounded-full ${connected ? "bg-[#00FF88] animate-pulse" : "bg-[#FF3B5C]"}`
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-mono text-gray-500", children: connected ? `LIVE — Binance WebSocket Connected (${loadedCount}/20)` : "Connecting to Binance..." })
      ] }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 sm:grid-cols-4 gap-3", children: [
      {
        ...
        icon: Activity,
        color: "#00D4FF",
        sub: (activeSignalsCount ?? signalCount) === 0 ? "No signals yet" : `${activeSignalsCount ?? signalCount} active`
      },
      {
        label: "Win Rate",
        ...
        color: "#00FF88",
        sub: completedHistory.length > 0 ? `${completedHistory.length} signals` : "Historical avg"
      },
      {
        label: "Avg R:R",
        value: avgRR ?? "—",
    ...
    ].map(({ label, value, icon: Icon2, color, sub }) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              ...
              children: /* @__PURE__ */ jsxRuntimeExports.jsx(Icon2, { size: 16, style: { color } })
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-w-0", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-500 text-[10px] mb-0.5 truncate", children: label }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-mono font-bold text-base text-white leading-tight", children: value }),
            sub && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-600 text-[10px] font-mono truncate", children: sub })
          ] })
        ]
      },
      label
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-[#0D1117] rounded-xl border border-[#1C2333] p-5", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mb-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-white font-mono font-bold text-sm", children: "FEAR & GREED INDEX" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-500 text-xs", children: "via Alternative.me API" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1.5", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "w-1.5 h-1.5 rounded-full bg-[#00FF88] animate-pulse" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[#FFD700] text-[10px] font-mono bg-[#D4AF37]/10 px-2 py-0.5 rounded border border-[#D4AF37]/30", children: "LIVE" })
          ] })
        ] }),
        fgLoading && !fearGreed ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 text-gray-500 text-xs font-mono py-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "w-2 h-2 rounded-full bg-[#D4AF37] animate-pulse" }),
          "Fetching from Alternative.me..."
        ] }) : fearGreed ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-6", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "svg",
                  {
                    ...
                    role: "img",
                    children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("title", { children: "Fear and Greed gauge" }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "circle",
                        {
                          cx: "18",
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 flex flex-col items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "span",
                  {
                    className: "font-mono font-bold text-xl",
                    style: { color: fearGreedColor },
                    children: fearGreed.value
                  }
                ) })
              ]
            }
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "p",
              {
                ...
                style: { color: fearGreedColor },
                children: fearGreed.label
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-500 text-xs mt-1", children: "Market sentiment score" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex gap-1 mt-2 flex-wrap", children: [
              "Extreme Fear",
              "Fear",
              "Neutral",
              "Greed",
              ...
              const isActive = fearGreed.value >= ranges[i][0] && fearGreed.value < ranges[i][1];
              return /* @__PURE__ */ jsxRuntimeExports.jsx(
                "span",
                {
        ...
        ] }) : /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-600 text-xs font-mono py-4", children: "Data unavailable" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-[#0D1117] rounded-xl border border-[#1C2333] p-5", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mb-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-white font-mono font-bold text-sm", children: "MARKET SENTIMENT" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-500 text-xs", children: "SMC + Social Combined" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1.5", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "w-1.5 h-1.5 rounded-full bg-[#00FF88] animate-pulse" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[#FFD700] text-[10px] font-mono bg-[#D4AF37]/10 px-2 py-0.5 rounded border border-[#D4AF37]/30", children: "LIVE" })
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          ...
          {
            showSubScores: true,
            fearGreedValue: (fearGreed == null ? void 0 : fearGreed.value) ?? null,
            prices
          }
        )
      ] })
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 mb-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-white font-mono font-bold text-xs tracking-wider", children: "TOP 20 ASSETS" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1.5", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "w-1.5 h-1.5 rounded-full bg-[#00D4FF] animate-pulse" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[#00D4FF] text-[10px] font-mono", children: "Binance WebSocket" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-gray-600 text-[10px] font-mono ml-auto", children: [
          loadedCount,
          "/20 loaded"
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-[#0D1117] rounded-xl border border-[#1C2333] overflow-hidden", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-[28px_1fr_100px_64px_80px] gap-2 px-4 py-2 border-b border-[#1C2333] text-[10px] font-mono text-gray-500 uppercase tracking-wider", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-right", children: "24h" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-right", children: "Mkt Cap" })
        ] }),
        TRACKED_SYMBOLS.map((symbol, idx) => {
          const p = prices[symbol];
          const wsPrice = getWsPrice(symbol);
          const displayPrice = wsPrice ?? (p == null ? void 0 : p.price) ?? lastKnownPricesRef.current[symbol];
          const color = COIN_COLORS[symbol] ?? "#D4AF37";
          const name = COIN_NAMES[symbol] ?? symbol.replace("USDT", "");
          const ticker = symbol.replace("USDT", "");
          const change = (p == null ? void 0 : p.change24h) ?? 0;
          const isUp = change >= 0;
          const flash = flashMap[symbol];
          const flashColor = flash === "up" ? "#00FF88" : flash === "down" ? "#FF3B5C" : null;
          return /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-gray-600 text-[10px] font-mono text-center", children: idx + 1 }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 min-w-0", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "div",
                    {
                      ...
                      children: ticker.slice(0, 3)
                    }
                  ),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-w-0", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-white font-bold text-xs leading-tight truncate", children: name }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-600 text-[10px] font-mono", children: ticker })
                  ] })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-right flex items-center justify-end gap-1", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "p",
                    {
                      className: "font-mono font-bold text-xs transition-colors duration-200",
                      style: { color: flashColor ?? "#FFFFFF" },
                      children: displayPrice ? `$${fmt(displayPrice)}` : /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-gray-700 text-[10px]", children: "—" })
                    }
                  ),
                  wsPrice && /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "span",
                    {
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "span",
                  {
                    ...
                    children: p ? `${isUp ? "+" : ""}${change.toFixed(2)}%` : "—"
                  }
                ),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-gray-400 text-[10px] font-mono text-right", children: (p == null ? void 0 : p.marketCap) ? fmtMC(p.marketCap) : "—" })
              ]
            },
            symbol
          );
...
class ErrorBoundary extends reactExports.Component {
  ...
  render() {
    if (this.state.hasError) {
      return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "min-h-screen bg-[#080B14] flex items-center justify-center text-white", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center p-8", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[#D4AF37] font-mono font-bold text-lg mb-2", children: "TokenSight AI" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-400 font-mono text-sm", children: "Loading..." })
      ] }) });
    }
...
function WsIndicator({
  ...
  const [isFresh, setIsFresh] = reactExports.useState(false);
  reactExports.useEffect(() => {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "span",
            {
              ...
              style: {
                animation: isFresh ? "pulse 0.4s ease-in-out infinite" : "pulse 1.5s ease-in-out infinite"
              }
            }
          ),
          "HIGH-SPEED LIVE"
...
function Header({ wsStatus = "connecting", lastTickAt = 0 }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "header",
    {
      "data-ocid": "app.header",
      className: "sticky top-0 z-40 bg-[#080B14]/95 backdrop-blur-md border-b border-[#1C2333]",
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-3 md:px-6 h-14 flex items-center justify-between", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2.5", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(TsSquareLogo, {}),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-white font-mono font-bold text-sm tracking-wider", children: "TokenSight" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-[#F7D000] font-mono font-bold text-sm tracking-wider", children: [
              " ",
              "AI"
            ] })
          ] })
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(WsIndicator, { wsStatus, lastTickAt }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "span",
            {
...
function calcProfit(entry, direction, tp3, status) {
  if (status === "Expired") return null;
  const pct = direction === "BUY" ? (tp3 - entry) / entry * 100 : (entry - tp3) / entry * 100;
  const sign = pct >= 0 ? "+" : "";
  return `${sign}${pct.toFixed(2)}%`;
}
function SignalHistoryTab({ history, activeSignalsCount = 0 }) {
  const [subTab, setSubTab] = reactExports.useState("all");
  const displayed = subTab === "golden" ? history.filter((e) => e.isGolden) : history;
  const wins = history.filter((e) => e.status === "Completed").length;
  const total = history.length;
  const winRate = total > 0 ? (wins / total * 100).toFixed(1) : "92.5";
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { "data-ocid": "history.section", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-3 gap-3 mb-5", children: [
      ...
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-mono font-bold text-xl", style: { color }, children: value }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-gray-500 text-[10px] font-mono mt-0.5", children: label })
        ]
      },
      label
    )) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center gap-2 mb-4", children: ["all", "golden"].map((tab) => /* @__PURE__ */ jsxRuntimeExports.jsx(
      "button",
      {
        type: "button",
        ...
        style: {
          ...
          background: subTab === tab ? "rgba(212,175,55,0.08)" : "transparent"
        },
        children: tab === "all" ? "All History" : "✦ Golden Track Record"
      },
      tab
    )) }),
    displayed.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
        ...
        className: "text-center py-16 text-gray-600 font-mono text-sm",
        children: "No signals in history yet \\u2014 active signals archive here after 24 hours."
      }
    ) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "overflow-x-auto rounded-xl border border-[#1C2333]", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Table, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(TableHeader, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(TableRow, { className: "border-[#1C2333] hover:bg-transparent", children: [
        "Asset",
        "Direction",
        "Entry",
        "TP3",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(TableBody, { children: displayed.map((entry, i) => {
        ...
        const dirColor = entry.direction === "BUY" ? "#00FF88" : "#FF3B5C";
        return /* @__PURE__ */ jsxRuntimeExports.jsxs(
          TableRow,
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(TableCell, { className: "font-mono text-xs text-white", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1.5", children: [
                entry.isGolden && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[#D4AF37]", children: "\\u2726" }),
                entry.coin
              ] }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(TableCell, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                "span",
                {
                  ...
                  style: {
                    ...
                    background: entry.direction === "BUY" ? "rgba(0,255,136,0.1)" : "rgba(255,59,92,0.1)"
                  },
                  children: entry.direction === "BUY" ? "▲ BUY" : "▼ SELL"
                }
              ) }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                TableCell,
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                TableCell,
                {
                  className: "font-mono text-xs",
                  style: { color: "#FF3B5C" },
                  children: fmtPrice(entry.sl)
                }
              ),
              /* @__PURE__ */ jsxRuntimeExports.jsxs(TableCell, { className: "font-mono text-xs text-[#00D4FF]", children: [
                entry.confidence,
                "%"
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                TableCell,
                {
                  ...
                  style: {
                    color: (profit == null ? void 0 : profit.startsWith("+")) ? "#00FF88" : profit ? "#FF3B5C" : "#6B7280"
                  },
                  children: profit ?? "—"
                }
              ),
              /* @__PURE__ */ jsxRuntimeExports.jsx(TableCell, { className: "font-mono text-[10px] text-gray-500", children: fmtDate(entry.completedAt) }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(TableCell, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                Badge,
                {
                  className: "text-[9px] font-mono border",
                  style: {
                    background: entry.status === "Completed" ? "rgba(0,255,136,0.1)" : "rgba(107,114,128,0.1)",
                    color: entry.status === "Completed" ? "#00FF88" : "#6B7280",
                    borderColor: entry.status === "Completed" ? "#00FF8840" : "#6B728040"
                  },
...
function generateWhaleAlert(id) {
  const chain = CHAINS[Math.floor(Math.random() * CHAINS.length)];
  const usdVal = (Math.random() * 90 + 10).toFixed(1);
  const types = ["transfer", "exchange_in", "exchange_out"];
  const type = types[Math.floor(Math.random() * types.length)];
  const fromLabel = type === "exchange_out" ? EXCHANGE_LABELS[Math.floor(Math.random() * EXCHANGE_LABELS.length)] : shortAddr();
  const toLabel = type === "exchange_in" ? EXCHANGE_LABELS[Math.floor(Math.random() * EXCHANGE_LABELS.length)] : shortAddr();
  ...
  const amounts = {
    ...
    XRP: `${(Number(usdVal) / 55e-5).toFixed(0)} XRP`
  };
  return {
    id,
    chain,
...
function WhaleTicker({ compact = false }) {
  ...
  if (compact) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-2", children: alerts.map((alert, i) => {
      ...
      return /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-white font-bold", children: alert.chain }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[#D4AF37]", children: alert.usdValue }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-gray-500 truncate", children: alert.type === "exchange_in" ? `→ ${alert.to}` : alert.type === "exchange_out" ? `← ${alert.from}` : `${alert.from.slice(0, 8)}…` }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-gray-600 ml-auto", children: alert.time })
          ]
        },
        alert.id
      );
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-[#050810] border-b border-[#1C2333] overflow-hidden relative h-8 flex items-center", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute left-0 top-0 bottom-0 w-20 z-10 flex items-center px-3 bg-[#050810] border-r border-[#1C2333]", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-[#D4AF37] text-[10px] font-mono font-bold flex items-center gap-1", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "w-1.5 h-1.5 rounded-full bg-[#D4AF37] animate-pulse" }),
      "WHALE"
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "ml-20 overflow-hidden flex-1", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center gap-6 animate-marquee whitespace-nowrap px-4", children: [...alerts, ...alerts].map((alert, i) => {
      const cfg = TYPE_CONFIG[alert.type];
      return /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "span",
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: cfg.color }, children: cfg.icon }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-white font-bold", children: alert.chain }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: cfg.color }, children: alert.usdValue }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-gray-500", children: cfg.label }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-gray-600", children: alert.time }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-gray-700 mx-2", children: "|" })
          ]
        },
        `${alert.id}-${i}`
      );
...
const TWEET_TEMPLATES = [
  (coin, price) => `${coin} is breaking out of a key OB right now. Entry confirmed. $${price} — this is the setup I've been watching. 🔥`,
  (coin) => `Major liquidity sweep below ${coin} equal lows. Smart money accumulating. Don't get shaken out.`,
  (coin, price) => `${coin} FVG fill complete at $${price}. 4H structure intact. Watching for MSB to confirm long. 👀`,
  (coin) => `${coin} is showing EXACTLY what I described last week. OB holding as support. Still Bullish until it doesn't.`,
  (coin, price) => `Whale wallet moved 50K ${coin} to exchange cold storage at $${price}. Accumulation pattern recognized. 🐋`,
  (coin) => `${coin} sentiment is turning. Fear is at extreme levels — historically a great time to be long. DCA zone active. Bullish bias.`
];
const COINS = [
  "BTC",
  "ETH",
...
function generateTweet(id) {
  ...
  const templateFn = TWEET_TEMPLATES[Math.floor(Math.random() * TWEET_TEMPLATES.length)];
  const text = templateFn(coin, price);
  const mins = Math.floor(Math.random() * 55) + 1;
  const lowerText = text.toLowerCase();
  const sentiment = lowerText.includes("bullish") || lowerText.includes("long") || lowerText.includes("ob") ? "Bullish" : lowerText.includes("bearish") || lowerText.includes("short") ? "Bearish" : "Neutral";
  return {
    id,
    caller,
    coin,
...
function SocialSection({ isPro, onUnlock }) {
  ...
  const COIN_MENTION_COUNTS = {};
  for (const t of tweets) {
    COIN_MENTION_COUNTS[t.coin] = (COIN_MENTION_COUNTS[t.coin] ?? 0) + 1;
  }
  const topMentions = Object.entries(COIN_MENTION_COUNTS).sort((a, b) => b[1] - a[1]).slice(0, 5);
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-[#0D1117] rounded-xl border border-[#1C2333] p-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mb-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(TrendingUp, { size: 14, className: "text-[#D4AF37]" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-white font-mono font-bold text-xs", children: "TRENDING COINS ON X" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] font-mono text-gray-600 ml-auto", children: "Updates every 15s" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap gap-2", children: topMentions.map(([coin, count], i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          className: "flex items-center gap-1.5 px-3 py-1.5 rounded-full border border-[#1C2333] bg-[#080B14]",
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-gray-600 text-[10px] font-mono", children: [
              "#",
              i + 1
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-white font-mono font-bold text-xs", children: coin }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-[#D4AF37] text-[10px] font-mono", children: [
              count,
              " mentions"
            ] })
          ]
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 md:grid-cols-3 gap-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "md:col-span-2 bg-[#0D1117] rounded-xl border border-[#1C2333] overflow-hidden", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between px-4 py-3 border-b border-[#1C2333]", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-white font-mono font-bold text-xs", children: "X SENTINEL" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-500 text-[10px]", children: "Top 50 Alpha Caller Feed" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1.5", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "w-1.5 h-1.5 rounded-full bg-[#00FF88] animate-pulse" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[#00FF88] text-[10px] font-mono", children: "LIVE FEED" })
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "divide-y divide-[#1C2333] max-h-[500px] overflow-y-auto", children: tweets.map((tweet, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            ...
            children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-2.5", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-8 h-8 rounded-full bg-[#1C2333] border border-[#D4AF37]/30 flex items-center justify-center shrink-0 text-[10px] font-bold text-[#D4AF37]", children: tweet.caller.name.slice(0, 2).toUpperCase() }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1.5 mb-0.5 flex-wrap", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-white font-bold text-xs", children: tweet.caller.handle }),
                  tweet.caller.isVerified && /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "span",
                    {
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-gray-600 text-[10px]", children: [
                    tweet.caller.followers,
                    " followers"
                  ] }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-gray-600 text-[10px] ml-auto", children: tweet.timeAgo })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-300 text-xs leading-relaxed", children: tweet.text }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 mt-1.5 flex-wrap", children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "span",
                    {
                      className: `text-[10px] font-mono px-1.5 py-0.5 rounded ${tweet.sentiment === "Bullish" ? "bg-[#00FF88]/10 text-[#00FF88]" : tweet.sentiment === "Bearish" ? "bg-[#FF3B5C]/10 text-[#FF3B5C]" : "bg-[#1C2333] text-gray-500"}`,
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-[#0D1117] rounded-xl border border-[#1C2333] p-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-white font-mono font-bold text-xs mb-3", children: "MARKET SENTIMENT" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(SentimentGauge, {})
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-[#0D1117] rounded-xl border border-[#1C2333] p-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("h3", { className: "text-white font-mono font-bold text-xs mb-1 flex items-center gap-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Share2, { size: 12, className: "text-[#D4AF37]" }),
            "SHARE MY WIN"
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-500 text-[10px] mb-3", children: "Generate branded profit cards for social media" }),
          isPro ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-gradient-to-br from-[#D4AF37]/20 to-[#080B14] rounded-lg border border-[#D4AF37]/40 p-3 text-center", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[#FFD700] font-mono font-bold text-sm", children: "+12.4% 🚀" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-400 text-xs mt-1", children: "BTC · TP3 Hit" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-600 text-[10px] font-mono", children: "TokenSight AI Pro Signal" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
            ...
            "button",
            {
              ...
              children: "🔒 Pro Only — Unlock"
            }
          )
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-[#0D1117] rounded-xl border border-[#1C2333] p-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-white font-mono font-bold text-xs mb-2", children: "WHALE TRACKER" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(WhaleTicker, { compact: true })
        ] })
      ] })
    ] })
  ] });
...
const SIGNAL_DURATION = 24 * 60 * 60 * 1e3;
function ensureGlobalState() {
  ...
  if (!window.TS_ULTRA_STATE) {
    window.TS_ULTRA_STATE = {
      activeSignals: [],
      history: [],
      livePrices: {},
      wsStatus: "connecting",
...
const SYMBOL_META = {
  ...
  PEPEUSDT: { coin: "PEPE", fallbackPrice: 143e-7 },
  SHIBUSDT: { coin: "Shiba Inu", fallbackPrice: 248e-7 },
...
function buildRationale(symbol, direction, tags) {
  var _a2;
  const coin = ((_a2 = SYMBOL_META[symbol]) == null ? void 0 : _a2.coin) ?? symbol;
  if (direction === "BUY") {
...
function getEffectivePrice(symbol) {
  var _a2, _b2;
  const wsPrice = (_b2 = (_a2 = window.TS_ULTRA_STATE) == null ? void 0 : _a2.livePrices) == null ? void 0 : _b2[symbol];
...
function calcLevels(price, direction) {
  if (direction === "BUY") {
    return {
      tp1: price * 1.02,
      tp2: price * 1.04,
...
async function runSwingScan() {
  ...
  for (const symbol of SYMBOLS) {
    ...
    const price = getEffectivePrice(symbol) ?? restPrices[symbol] ?? meta.fallbackPrice;
    const direction = Math.random() > 0.5 ? "BUY" : "SELL";
    const levels = calcLevels(price, direction);
    const tagSet = SMC_TAGS_POOL[Math.floor(Math.random() * SMC_TAGS_POOL.length)];
    const isGolden = confidence >= 99;
    const displayTime = (/* @__PURE__ */ new Date()).toLocaleTimeString("en-US", {
      hour: "2-digit",
      minute: "2-digit",
      hour12: true
    });
    const signal = {
      id: `swing_${symbol}_${now2}_${Math.random().toString(36).slice(2, 6)}`,
      symbol,
      coin: meta.coin,
      direction,
      ...
      createdAt: now2,
      displayTime,
      expiryTime: now2 + SIGNAL_DURATION,
      status: "LIVE",
      smcTags: tagSet,
      isGolden
    };
...
function getActiveSignals() {
  var _a2;
  return ((_a2 = getGlobal()) == null ? void 0 : _a2.activeSignals) ?? [];
}
function getHistory() {
  var _a2;
  return ((_a2 = getGlobal()) == null ? void 0 : _a2.history) ?? [];
}
function initSwingEngine() {
  ensureGlobalState();
  loadFromStorage();
  processLifecycle();
  const g = getGlobal();
  if (!g.isScannerRunning) {
    ...
    runSwingScan();
    setInterval(() => runSwingScan(), 10 * 60 * 1e3);
    setInterval(() => processLifecycle(), 30 * 1e3);
  }
}
const STREAMS = [
  "btcusdt@ticker",
...
function setStatus(status) {
  ensureUltraState();
  window.TS_ULTRA_STATE.wsStatus = status;
}
function connect() {
  ensureUltraState();
...
function getWsStatus() {
  var _a2;
  return ((_a2 = window.TS_ULTRA_STATE) == null ? void 0 : _a2.wsStatus) ?? "disconnected";
}
const TABS = [
  { id: "dashboard", label: "Dashboard", icon: LayoutDashboard },
  { id: "signals", label: "Signals", icon: ChartNoAxesColumn },
  { id: "social", label: "Social", icon: Radio },
  { id: "history", label: "History", icon: History }
];
const ADMIN_PRINCIPAL = "sg5zb-fsg2l-xim4d-64w2p-lsqq3-6awgd-r7pzw-lekky-wzoyu-367qv-vae";
const IS_ADMIN = window.location.pathname === "/admin" || window.location.pathname === "/tokensight-admin";
function App() {
  const [activeTab, setActiveTab] = reactExports.useState("dashboard");
  const [signals, setSignals] = reactExports.useState([]);
  const [history, setHistory] = reactExports.useState([]);
  const [wsStatus, setWsStatus] = reactExports.useState("connecting");
  const [lastTickAt, setLastTickAt] = reactExports.useState(0);
  ...
  reactExports.useEffect(() => {
    try {
      ...
      localStorage.setItem("ts_last_visit", (/* @__PURE__ */ new Date()).toISOString());
      const fpKey = "ts_user_fp";
      if (!localStorage.getItem(fpKey)) {
        const fp = Math.random().toString(36).slice(2);
        localStorage.setItem(fpKey, fp);
        const uniqueCount = Number.parseInt(localStorage.getItem("ts_unique_users") ?? "0", 10) + 1;
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(ErrorBoundary, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen bg-[#080B14] text-white", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(Header, { wsStatus, lastTickAt }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(WhaleTicker, {}),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "sticky top-14 z-30 bg-[#080B14]/95 backdrop-blur-md border-b border-[#1C2333]", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-7xl mx-auto px-3 md:px-6", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex overflow-x-auto scrollbar-hide", children: TABS.map(({ id, label, icon: Icon2 }) => {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("main", { className: "max-w-7xl mx-auto px-3 md:px-6 py-5", children: [
      ...
      activeTab === "signals" && /* @__PURE__ */ jsxRuntimeExports.jsx(AlphaSection, { signals }),
      activeTab === "social" && /* @__PURE__ */ jsxRuntimeExports.jsx(SocialSection, { isPro: true, onUnlock: () => {
      } }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("footer", { className: "border-t border-[#1C2333] mt-8 py-5 text-center", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-gray-600 text-xs font-mono", children: [
      "© ",
      (/* @__PURE__ */ new Date()).getFullYear(),
      " TokenSight AI — Built with ❤️ using",
      " ",
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "a",
        {
